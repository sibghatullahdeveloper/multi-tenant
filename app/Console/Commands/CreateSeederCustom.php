...
class CreateSeederCustom extends GeneratorCommand
{
    /**
    ...
    {
        return app_path('Console/Stubs/seeder.stub');
    }
    ...
    protected function getDefaultNamespace($rootNamespace)
    {
        ...
        if(in_array($this->argument('module'),$modules) && is_dir($path)){
            return $rootNamespace.'/Modules/'.$version.'/'.$this->argument("module").'/Seeders';
        }else{
    ...
    {    
        ...
        $path = $path.'/'.$this->argument('module');
        if(in_array($this->argument('module'),$modules) && is_dir($path)){
            $namespace = ("App\Modules\\".$version.'\\'.$this->argument("module").'\Seeders');
