        ...
        <div class="row">
            <div class="col-12">
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{route('seo.add.form',['role' => \Auth::user()->role->slug])}}">
                  @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="keywords"  id="keywords" placeholder="Keyword,Keyword,Keyword" value="{!! old('keywords','') !!}">
                      </div>
                    </div>
                    <div class="form-group row">
