              ...
              @if (in_array('create',$active_permissions))
                <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">
                        <a href="{{route('seo.add.view',['role' => \Auth::user()->role->slug])}}">
                          <button class="btn success">
                            <i class="fas fa-plus-square"></i> Add SEO
                          </button>
                        </a>
                      </h3>
                    </div>
                        ...
                        <td>
                          @if (in_array('update',$active_permissions) || in_array('delete',$active_permissions))
                            @if (in_array('update',$active_permissions))
                              <a href="{{route('seo.edit.view',['role' => \Auth::user()->role->slug, 'id' => $seo->id ])}}">
                            ...
                            @if (in_array('delete',$active_permissions))
                              <a class="delete-confirmation" href="{{route('seo.delete.form',['role' => \Auth::user()->role->slug, 'id' => $seo->id ])}}">
