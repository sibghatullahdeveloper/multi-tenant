...
<div class="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Email Send to Your Address, Please Enter Code .</p>

      <form action="{{route('admin.verify.code.form',$email)}}" method="POST">
        @csrf
      ...
      <p class="mt-3 mb-1">
        <a href="{{route('admin.login.view')}}">Login</a>
      </p>
