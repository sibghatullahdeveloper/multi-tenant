        ...
        <div class="row">
            <div class="col-12">
              <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="{{route('category.edit.form',['role' => \Auth::user()->role->slug])}}">
                  @csrf
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" name="description" id="description" value="{!! old('title',$data->description) !!}" placeholder="Description">
                      </div>
                    </div>
                  </div>
                  <!-- /.card-body -->
